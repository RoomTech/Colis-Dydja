        ...
        <div class="border-t border-gray-200 p-4 sm:px-6">
            <dl class="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
                ...
                <div class="sm:col-span-1">
                    ...
                    <dd class="mt-1 text-lg text-gray-900">{{ $user->compagnie_id }}</dd>
                </div>

                <div class="sm:col-span-1">
                    <dt class="text-sm font-medium text-gray-500">Nom complet</dt>
                    <dd class="mt-1 text-lg text-gray-900">{{ $user->fullname}}</dd>
                </div>
                <div class="sm:col-span-1">
                    <dt class="text-sm font-medium text-gray-500">Profil</dt>
                    <dd class="mt-1 text-lg text-gray-900">{{ $user->profil }}</dd>
                </div>
                <div class="sm:col-span-1">
